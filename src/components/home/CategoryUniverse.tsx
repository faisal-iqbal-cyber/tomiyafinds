        ...
        <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
          {categories.map((category, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-[#cfa777]/0 transition duration-500 group-hover:bg-[#cfa777]/[0.05]" />
              ...
              <div className="absolute inset-x-0 bottom-0 z-10 p-7 md:p-9">
                ...
                <div className="mt-7 flex h-12 w-12 items-center justify-center rounded-full border border-white/30 bg-black/20 backdrop-blur-md transition duration-300 group-hover:scale-110 group-hover:border-[#dfbd91] group-hover:bg-[#dfbd91] group-hover:text-black">
